// Main rendering loop for complete solar system with 9 objects (sun + 8 planets)
#include "gl.h"
...
Usage:
  ...
  while (!glfwWindowShouldClose(window))
  {
    ...
    // Draw all 9 objects: sun + 8 planets
    for(int i = 0;i<9;i++)
    {
      glUniform1i(glGetUniformLocation(prog_id, "is_planet"), i > 0);
      glUniform1i(glGetUniformLocation(prog_id, "planet_index"), i);
